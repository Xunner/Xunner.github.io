...
const getEcommerceData = (data, ecommerce) => {
  ...
  */
  const secData = (ecommerce && ecommerce.items) || (eventModel && eventModel.items);
  if (secData) {
...
const getUserDataFromDataLayer = () => {
  var userData = {};
  const email = (userDataFromDataLayer && userDataFromDataLayer.email_address) || (eventModel && eventModel.user_data && eventModel.user_data.email_address);
  const phone = (userDataFromDataLayer && userDataFromDataLayer.phone_number) || (eventModel && eventModel.user_data && eventModel.user_data.phone_number);
  if (email) {
    if (isHashed(email)) {
