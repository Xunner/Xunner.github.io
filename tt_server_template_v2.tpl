...
[
  ...
  {
    "type": "GROUP",
    "name": "Section 2 - Additional Object Properties",
  ...
  },
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "help": "Configure and send \u003ca href\u003d\"https://ads.tiktok.com/help/article?aid\u003d10028\"\u003eadditional parameters\u003c/a\u003e to TikTok for to improve Ad performance and unlock Ad features."
      },
      {
        "type": "GROUP",
...
function getItems() {
  ...
  if (eventData.ecommerce_str) {
    const ecommerce = JSON.parse(eventData.ecommerce_str);
    if (ecommerce) {
...
- name: TestEcommerceParsing
  code: |-
    ...
    const mockEventData = {
      ...
      ecommerce_str: '{"items":[{"item_name":"Test T-Shirt","item_id":"12345","price":15.25,"item_brand":"testbrand","item_category":"Apparel","item_variant":"Red","quantity":1,"currency":"USD"},{"item_name":"Test Pants","item_id":"67890","price":33.33,"item_brand":"testbrand","item_category":"Apparel","item_variant":"Blue","quantity":2,"currency":"USD"}]}',
      client_hints: {
        architecture: "x86",
        bitness: "64",
        full_version_list: [
    ...
    assertThat(actualReqBody.event).isEqualTo('AddPaymentInfo');
    assertThat(actualReqBody.context.device).isEqualTo({
      architecture: "x86",
      bitness: "64",
    ...
    assertThat(actualReqBody.properties.event_trigger_source).isEqualTo('GoogleTagManagerServer');
    assertThat(actualReqBody.properties.value).isEqualTo(81.91);
    assertThat(actualReqBody.properties.currency).isEqualTo('USD');
    assertThat(actualReqBody.properties.contents).isEqualTo([
      {
        "content_id": "12345",
        "content_name": "Test T-Shirt",
        "price": 15.25,
